    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DangKy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isNotEmpty(TK) && isNotEmpty(MK) && isNotEmpty(MK2) && isNotEmpty(Ho) && isNotEmpty(Ten) && isNotEmpty(NS)
                        && isNotEmpty(DC) && isNotEmpty(DT) && isNotEmpty(Email)) {
                ...
                else Toast.makeText(RegisterActivity.this, "Không được trống!!", Toast.LENGTH_SHORT).show();
            }
        });
    }
